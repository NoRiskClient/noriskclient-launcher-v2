...
export const installNoRiskFabric = (props: LauncherProps): void => {
  checkForVersionsFolder(props)
}

const checkForVersionsFolder = (props: LauncherProps): void => {
  ...
  downloadAndWriteFile('https://noriskclient.de/downloads/launcher/1.16.4-NRC-Fabric.json', {
    ...
    installLibraries(NRC_FABRIC_1_16_4, () => {
      launchGame(NRC_FABRIC_1_16_4, props.profile)
